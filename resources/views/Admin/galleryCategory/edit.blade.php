...
<!--begin::Entry-->
    ...
    @endif
														<form class="form" id="kt_form" action="{{ route('gategory.update',$category->g_id) }}" method="POST" enctype="multipart/form-data">
																	...
																	<div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
																		...
																		<div class="form-group row">
																			...
																			<div class="col-lg-9 col-xl-9">
																				<input class="form-control form-control-solid form-control-lg" name="categoryname" type="text" value="{{ $category->g_name }}" />
																			</div>
																		</div>
																		<!--end::Group-->
																		...
																		<div class="form-group row">
																			...
																			<div class="col-lg-9 col-md-9 col-sm-12">
																				<select class="form-control" name="status">
																						<option value="{{ $category->g_status }}">{{ $category->g_status }}</option>
																			@if ($category->g_status='Active')
